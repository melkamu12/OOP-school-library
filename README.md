...
1. Clone this repository to your local machine:
   ...
   ```bash
 https://github.com/melkamu12/OOP-school-library.git
   ```
...
- Adding user reaction like rating and reviews
...
Feel free, If you'd like to contribute, please follow these steps:
